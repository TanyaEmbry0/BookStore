...
export class BookService {
  ...
  getBooks(): Observable<any> {
    return this.httpClient.get<IBook>(
      'https://murmuring-cliffs-61613.herokuapp.com/books'
    );
  }

  getBook(id: string): Observable<any> {
    return this.httpClient.get<IBook>(
      `https://murmuring-cliffs-61613.herokuapp.com/books/${id}`
    );
  }

  addBook(body: CreatedBook, token: string) {
    return this.httpClient.post(
      'https://murmuring-cliffs-61613.herokuapp.com/books/create',
      {
        headers: {
